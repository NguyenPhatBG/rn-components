...
} from '../musicTrack/reducers/Playlist/actions'

import Item from './Item'
import Title from './Title'

import Colors from '../musicTrack/constants';
import { Download } from '../musicTrack/components/Icons'
			...
			const response = [
                {
                    ...
                    "exists": true,
                    "videoId": 1,
                    "title": "Hương Tràm - ca sĩ của năm và giọng nữ 9X số một nhạc Việt",
                    "artwork": "Em Gái Mưa"
                },
                {
                    "playlistId": 2,
                    "exists": false,
                    "videoId": 2,
                    "title": "Hiền Hồ - gương mặt gây tranh cãi thành ca sĩ mới ấn tượng nhất năm",
                    "artwork": "Em ngày xưa khác rồi"
                },
            ];
