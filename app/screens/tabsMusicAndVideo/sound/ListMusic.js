...
const Feature = ({title, onPress, description, buttonLabel = 'PLAY', status, navigation, music}) => (
  <TouchableOpacity style={styles.feature} onPress={() => navigation.push('PlayerScreen', { music, title })}>
